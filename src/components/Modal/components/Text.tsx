...
const textVariants = cva('font-plex-sans', {
  variants: {
    variant: {
      ...
      description: 'text-[1.8rem] font-medium text-gray-dark-11',
      subtitle: 'font-plex-sans text-[1.6rem] text-gray-dark-12 font-semibold',
      feature:
        'text-[1.2rem] font-medium uppercase tracking-[0.256rem] text-gray-dark-11',
      primary: 'text-gray-dark-12',
      secondary: 'text-gray-dark-11 text-[1.4rem]',
    },
    size: {
      '2xs': 'text-[1rem]',
      xs: 'text-[1.2rem]',
