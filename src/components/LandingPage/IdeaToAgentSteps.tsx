      ...
      <div className="relative max-w-[800px] self-center">
        <div className="mt-36 grid grid-cols-3 gap-24">
          <div className="flex flex-col gap-20">
            <div>
              <div className="rounded-8 border border-neutral-6 bg-neutral-1 p-10">
                <img
          ...
          <div className="flex flex-col gap-20">
            <div className="grid place-content-center rounded-8 border border-neutral-6 bg-neutral-1 py-28">
          ...
          <div className="flex flex-col gap-20">
            <div className="flex-1 rounded-8 border border-neutral-6 bg-neutral-1" />
            <div className="flex flex-col items-center text-center">
              <div className="z-10 grid aspect-1 size-38 place-content-center rounded-full border border-neutral-6 bg-black text-16 text-neutral-12">
                3
              </div>
