...
> = {
  ...
  claude_vertex: { CLAUDE_VERTEX_API_KEY: 'your-key-here' },
  grok: { GROK_API_KEY: 'your-key-here' },
  groq: { GROQ_API_KEY: 'your-key-here' },
  llama_cloud: { LLAMA_CLOUD_API_KEY: 'your-key-here' },
  llama_local: { LLAMA_LOCAL_API_KEY: 'your-key-here' },
  ollama: { OLLAMA_API_KEY: 'your-key-here' },
  redpill: { REDPILL_API_KEY: 'your-key-here' },
  openrouter: { OPENROUTER_API_KEY: 'your-key-here' },
  heurist: { HEURIST_API_KEY: 'your-key-here' },
};
...
export const SECRETS_CLIENT_MAP: Record<Client, Record<string, string>> = {
  ...
  direct: { DIRECT_API_TOKEN: 'your-token-here' },
  twitter: {
    TWITTER_USERNAME: 'your-account-username',
    TWITTER_PASSWORD: 'your-account-password',
    TWITTER_EMAIL: 'your-account-email',
  },
  telegram: { TELEGRAM_BOT_TOKEN: 'your-token-here' },
  farcaster: {
    FARCASTER_NEYNAR_API_KEY: 'your-key-here',
    FARCASTER_FID: 'your-fid-here',
    FARCASTER_NEYNAR_SIGNER_UUID: 'your-signer-uuid-here',
  },
  lens: { LENS_TOKEN: 'your-token-here' },
  auto: { AUTO_TOKEN: 'your-token-here' },
  slack: { SLACK_TOKEN: 'your-token-here' },
};
