...
function CategoryCard({ link, image, title }: CategoryCardsProps) {
  return (
    <a
      href={link}
      className="block h-full w-full rounded-[8px] border-[1px] border-gray-dark-7 py-[17px] transition-all duration-150 ease-out hover:-translate-y-[1rem] hover:border-gray-dark-8 md:w-[85%]"
    >
