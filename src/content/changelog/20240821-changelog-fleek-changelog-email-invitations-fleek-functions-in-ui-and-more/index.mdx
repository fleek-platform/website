...
You can try out all the new features for yourself directly in the <u>[Fleek app](https://fleek.xyz/dashboard)</u>. Let’s dive into what the team has been working on in August:
...
Previously, Fleek Functions were accessible only via the Fleek CLI. That’s changed with this new release as you can now create, manage, and customize Fleek Functions directly from the <u>[Fleek app](https://fleek.xyz/dashboard)</u> UI!
...
You can go to [fleek.xyz/changelog](https://fleek.xyz/changelog) to check out the new page 🤙
