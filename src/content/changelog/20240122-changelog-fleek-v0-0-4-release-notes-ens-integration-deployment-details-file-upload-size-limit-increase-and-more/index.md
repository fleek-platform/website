...
We're back with an update to the Fleek.xyz Alpha! This jam-packed v.0.0.4 update brings us to near-feature parity with the Fleek.co platform, an important goal for the team as we approach the start of the [Fleek.co to Fleek.xyz migration](https://resources.fleek.xyz/blog/announcements/fleek-co-to-fleek-xyz-migration-details/).
...
You can see a full list of changes included in the v0.0.4 release of the Fleek.xyz alpha in our [docs](https://resources.fleek.xyz/docs/)!
