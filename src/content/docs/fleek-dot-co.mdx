...
Fleek users should take note of a significant change on the horizon: we'll be sunsetting Fleek.co & fully migrating to Fleek.xyz in early 2025. This transition marks more than just a domain change: it’s a significant move towards a more robust, resilient, and future-proof platform.
...
### ✅ Complete: Release alpha version of the Fleek.xyz platform, finalize migration process
...
### ✅ Complete: Release Fleek platform V1, migrate user data, troubleshoot any migration issues that arise
