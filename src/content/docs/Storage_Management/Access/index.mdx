...
Learn how to access files or directories to Fleek using the Platform or the CLI.
...
4. Optionally, you can set up a custom domain for a more performant and branded experience by following the steps in the [Gateways](/docs/other_features/gateways) section of the documentation.
...
For dynamically changing content, you can use IPNS to map dynamic IPFS hashes to a static record. See the [CLI](/docs/set_up/cli) or [SDK](/docs/sdk/) sections for more information on managing IPNS records.
