...
<DocIntroCard
  ...
  description="Upload the character file of your AI agent."
  href="/docs/deploy_ai_agents/upload-character-file"
/>
<DocIntroCard
  title="Build From Scratch"
  description="Build your agent from scratch"
  href="/docs/deploy_ai_agents/build-from-scratch"
/>
<DocIntroCard
  title="Select Template "
  description="Build your agent from our template"
  href="/docs/deploy_ai_agents/select-template"
/>
<DocIntroCard
  title="Troubleshooting"
  description="Troubleshooting"
  href="/docs/deploy_ai_agents/troubleshoot"
/>
