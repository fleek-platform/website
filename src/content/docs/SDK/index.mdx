...
<DocIntroCard
  title="Installation"
  description="Learn how to install the SDK and use it in your projects"
  href="/docs/sdk/installation"
/>
<DocIntroCard
  title="Projects"
  description="Understand how projects work in Fleek and navigate around them"
  href="/docs/sdk/projects"
/>
<DocIntroCard
  title="Storage"
  description="Learn how to access Fleek's storage capabilities using the SDK"
  href="/docs/sdk/storage"
/>
<DocIntroCard
  title="IPFS"
  description="Leverage IPFS and perpetually store files using Fleek SDK"
  href="/docs/sdk/ipfs"
/>
<DocIntroCard
  title="IPNS"
  description="Utilize IPNS in your projects using Fleek SDK"
  href="/docs/sdk/ipns"
/>
