...
5. You should see the logs for the agent you want to view:

![Eliza logs](./eliza-logs.png)

### From the Fleek App

1. Navigate to the [Fleek app](https://app.fleek.xyz/) dashboard.
...
With the logs, you can see the most recent information about how your agent is running by clicking the **Refresh Logs** button.
