...
https://api.staging.fleeksandbox.xyz/api/v1/ai-agents/{agentId}/api/{*key}
...
```jsx
fetch(
  'https://api.staging.fleeksandbox.xyz/api/v1/ai-agents/12345/api/message',
  {
    method: 'POST',
...
For more details, check the [**full API docs**](https://api.staging.fleeksandbox.xyz/api#tag/ai-agents/GET/api/v1/ai-agents/%7BagentId%7D/api/%7B*key%7D).
