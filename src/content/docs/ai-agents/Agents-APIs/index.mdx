...
https://api.fleeksandbox.xyz/api/v1/ai-agents/{agentId}/api/{*key}
...
For more details, check the [**full API docs**](https://api.fleek.xyz/api#tag/ai-agents/GET/api/v1/ai-agents/%7BagentId%7D/api/%7B*key%7D).
