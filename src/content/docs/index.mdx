...
Get started and pick your learning path and choose from the various products, frameworks and guides Fleek offers.

### Setup and installation

It's extremely important for users to sign up on the Platform and install the CLI before moving forward:

<div className="mb-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
  <DocIntroCard title="Set up Platform" href="/docs/set_up/platform" />
  <DocIntroCard title="Install CLI" href="/docs/set_up/cli" />
</div>
