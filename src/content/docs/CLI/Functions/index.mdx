...
To protect sensitive data and keep it private, you must deploy your Fleek Function with the `--private` flag. Click [here](https://fleek.xyz/docs/cli/functions/#making-fleek-functions-private--alpha) to learn more.
