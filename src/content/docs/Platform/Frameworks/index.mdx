...
Fleek's platform has some parts of it that are hosted on Fleek which includes not only the docs you are reading now, but the landing page, blog and all of which are within the [fleek.xyz](https://fleek.xyz) site.

At the moment Fleek is introducing more full stack capabilities and it will be done in a phased approach overtime as the network and web services needed are launched, hardened and well tested. Fleek aims to be a one-size-fits-all platform for developers.
