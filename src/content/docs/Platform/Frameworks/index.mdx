...
Some elements of Fleek's platform are hosted on Fleek, including not only the docs you are reading now, but also the landing page and blog. Each of these applications are hosted on the [fleek.xyz](https://fleek.xyz) site.

At the moment Fleek is introducing more full stack capabilities. This will be done in a phased approach over time, as Fleek Network and web services needed are launched, hardened and well tested. Fleek aims to be a one-size-fits-all platform for developers.
