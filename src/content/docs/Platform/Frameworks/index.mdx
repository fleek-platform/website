...
At the moment Fleek is introducing more full stack capabilities and it will be done in a phased approach overtime as the network and web services needed are launched, hardened and well tested. Fleek aims to be a one-size-fits-all platform.
