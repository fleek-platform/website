...
To add an ENS domain to your site, first create a site. If you don't have a site yet, please follow the steps in the [Projects](/docs/platform/projects/) section.
...
![OFAC control in settings](./ofac-control.webp)
