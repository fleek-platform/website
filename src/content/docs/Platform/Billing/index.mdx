...
There are two plan tiers on Fleek:

1. **Pro Plan**: $20 per month. Our most popular option for teams and growing projects.
2. **Enterprise Plan**: Starts at $1000/month. A custom plan for larger projects with custom needs.
...
- A fully custom plan tailored to meet all your specific needs.

For a thorough breakdown of the features of each plan, you can check out the [pricing page](https://resources.fleek.xyz/pricing).
