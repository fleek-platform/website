...
You can view your invoices on the Fleek platform. Invoices are generated for each billing cycle and can be downloaded as a PDF.
They are downloadable direcly from the "Billing" page on the Fleek platform right below the "Payment method" section.

The invoices show a breakdown of the charges for the billing cycle, including the plan and overages in the total amount charged. There are options to download a single invoice and to download them all.
