...
Click on the 'Delete' button in the modal that appears next to the key you want to delete. Once deleted, all resources using the API key will stop working.
