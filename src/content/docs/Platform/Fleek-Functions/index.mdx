...
2. The "Functions" page looks like below. Click on the "Create function" button on the extreme right-hand of the secondary navigation:
   ![functions page](./functions-page.webp)
...
![deployed function overview](./final-deployed-function-ui.webp)
...
![edit function name](./edit-function-name.webp)
...
![function slugs](./function-slugs.webp)
...
![confirm function deletion](./confirm-delete.webp)
