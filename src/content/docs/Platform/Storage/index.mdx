...
4. Optionally, you can set up a custom domain for a more performant and branded experience by following the steps in the [Gateways](https://hosting.fleek.xyz/cli/gateways/) section of the documentation.
...
For dynamically changing content, you can use IPNS to map dynamic IPFS hashes to a static record. See the [CLI](https://hosting.fleek.xyz/cli) or [SDK](https://hosting.fleek.xyz/sdk/) sections for more information on managing IPNS records.
