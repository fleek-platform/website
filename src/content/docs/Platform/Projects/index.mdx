...
:::note
Our current billing implementation is at the project level. You can learn more [here](https://resources.fleek.xyz/docs/platform/billing/).
:::
...
1. Go to the [Fleek dashboard](https://fleek.xyz/dashboard/).
...
You can now use the application token to authenticate your application with Fleek's services like the [SDK](https://hosting.fleek.xyz/sdk/).

### Managing application credentials

You can manage your application credentials by going to the `Application Credentials` tab in the `Settings` page of your project, within the [Fleek dashboard](https://fleek.xyz/dashboard/). Here you can view, edit, and delete your application credentials.

### Updating whitelisted domains

You can update, add or remove whitelisted domains for an application credential by clicking on the `Edit` button next to the application credential in the `Application Credentials` tab in the `Settings` page of your project, within the [Fleek dashboard](https://fleek.xyz/dashboard/).
