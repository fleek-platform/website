...
:::info
Ensure you have the Fleek CLI installed on your machine. Run `npm install -g @fleek-platform/cli` to install. Click [here](/docs/setup/cli) to learn more on how to setup the CLI.
:::
