...
**These events are handled asynchronously** for a more efficient and reliable process. For more information on events, check out the Fleek Leak blog post about our [event-driven architecture](https://resources.fleek.xyz/blog/announcements/fleek-leak-04-event-architecture/)!
